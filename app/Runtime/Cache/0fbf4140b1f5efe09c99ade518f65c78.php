...
<link rel="stylesheet" href="__ASSET__/css/style.css" type="text/css" media="screen"/>
<style>
span.reference {
	font-family:Arial;
	position:fixed;
...
<script type="text/javascript" src="__ASSET__/js/jquery.easing.1.3.js"></script>
...
<div id="fp_gallery" class="fp_gallery">
	<img src="/gallery/index/img/id/<?php echo ($images[0]['file_id']); ?>" alt="" class="fp_preview" style="display:none;"/>
    ...
    <div id="thumbScroller">
		<div class="container">
			<?php if(is_array($images)): $i = 0; $__LIST__ = $images;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="content">
				<div>
					<a href="#"><img src="/gallery/image/?w=80&h=120&id=<?php echo ($vo["file_id"]); ?>" alt="/gallery/index/img/id/<?php echo ($vo["file_id"]); ?>" class="thumb" /></a>
				</div>
			</div><?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
    </div>
  </div>
  <div id="fp_thumbtoggle" class="fp_thumbtoggle">查看缩略图</div>
</div>

<div>
	<span class="reference">
		<a href="#"><?php echo ($album["desc"]); ?></a>
	</span> 
</div>
